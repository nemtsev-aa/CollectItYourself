...
public class ScoreController : IService, IDisposable
{
    ...
    public void Init()
    {
        ...
        _eventBus.Subscribe<SwithingStartedSignal>(OnGameStarted);
        _eventBus.Subscribe<AddScoreSignal>(OnScoreAdded);
        //_eventBus.Subscribe<LevelFinishedSignal>(OnLevelFinished);
    }

    private void OnGameStarted(SwithingStartedSignal signal)
    {
        _score = 0;
    ...
    public void Dispose()
    {
        _eventBus.Unsubscribe<SwithingStartedSignal>(OnGameStarted);
